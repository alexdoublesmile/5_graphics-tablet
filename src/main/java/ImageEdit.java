...
public class ImageEdit
{
    ...
    public ImageEdit()
    {
        f=new MyFrame("Графический планшетик");
        f.setSize(1750,950);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        maincolor=Color.black;

        pencil = Toolkit.getDefaultToolkit()
            .createCustomCursor(Toolkit.getDefaultToolkit().getImage(
                    getClass().getResource("images/cursors/pencil.png")), new Point(8, 25), "pencil");
        marker = Toolkit.getDefaultToolkit()
            .createCustomCursor(Toolkit.getDefaultToolkit().getImage(
                    getClass().getResource("images/cursors/marker.png")), new Point(29, 30), "marker");
        eraser = Toolkit.getDefaultToolkit()
            .createCustomCursor(Toolkit.getDefaultToolkit().getImage(
                    getClass().getResource("images/cursors/eraser.png")), new Point(18, 15), "eraser");

        JMenuBar menuBar = new  JMenuBar();
        f.setJMenuBar(menuBar);
        menuBar.setBounds(0,0,350,30);
        JMenu fileMenu = new  JMenu("Файл");
        JButton cleanButton = new  JButton("Очистить тут всё");
        cleanButton.addActionListener(e -> {

            Graphics g = imag.getGraphics();
            Graphics2D g2 = (Graphics2D)g;
            g2.setColor(Color.white);
            g2.fillRect(0, 0, japan.getSize().width, japan.getSize().height);
        ...
        japan.setCursor(pencil);
        f.add(japan);

        JToolBar toolbar = new  JToolBar("Toolbar", JToolBar.HORIZONTAL);

        JButton penbutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/pen.png")));
        ...
        JButton brushbutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/brush.png")));
        brushbutton.addActionListener(new  ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
                rezhim=1;
                japan.setCursor(marker);
            }
        });
        toolbar.add(brushbutton);

        JButton lasticbutton = new JButton(new  ImageIcon(getClass().getResource("images/icons/lastic.png")));
        lasticbutton.addActionListener(new  ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
                rezhim=2;
                japan.setCursor(eraser);
            }
        });
        toolbar.add(lasticbutton);

        JButton textbutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/text.png")));
...
//        toolbar.add(textbutton);
        ...
        JButton linebutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/line.png")));
        linebutton.addActionListener(new  ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
                rezhim=4;
                japan.setCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));

            }
        });
        toolbar.add(linebutton);

        JButton elipsbutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/elips.png")));
        ...
        JButton rectbutton = new  JButton(new  ImageIcon(getClass().getResource("images/icons/rect.png")));
...
//        toolbar.setBounds(0, 0, 300, 30);
        ...
        colorbar.setBounds(30, 0, 460, 100);
...
//        colorbar.add(magentabutton);
        ...
        orangebutton.setBounds(180, 5, 15, 15);
...
//        colorbar.add(orangebutton);
        ...
        yellowbutton.setBounds(200, 5, 15, 15);
